  ...
  return (
    <header className='bg-black text-white fixed top-0 left-0 right-0'>
        <nav className='px-4 py-4 max-w-7xl mx-auto flex justify-between items-center'>
            <a href = "/" className='text-xl font-bold'>Design<span 
            className='text-orange-500'>DK</span></a>
            ...
            <div className='lg:flex gap-4 items-center hidden '>
                ...
                <button className='bg-orange-500 px-6 py-4 font-medium rounded hover:bg-white 
                hover:text-orange-500 transition-all duration-200 ease-in'>Login</button>
            </div>

            {/*Mobile menu buttons, display mobile screen*/}
            <div className='md:hidden'> {/*It will be hidden in medium devices*/}
